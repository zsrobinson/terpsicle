...
const courseAreaMapping: CourseAreaMapping = {
  // Area 1: Systems
  'CMSC411': ['Area 1'], 'CMSC412': ['Area 1'], 'CMSC414': ['Area 1'],
  'CMSC416': ['Area 1'], 'CMSC417': ['Area 1'], 'CMSC498B': ['Area 1'],
  'CMSC498C': ['Area 1'], 'CMSC498I': ['Area 1'], 'CMSC498K': ['Area 1'],
  'CMSC498X': ['Area 1'],
  // Area 2: Information Processing
  'CMSC420': ['Area 2'], 'CMSC421': ['Area 2'], 'CMSC422': ['Area 2'],
  'CMSC423': ['Area 2'], 'CMSC424': ['Area 2'], 'CMSC426': ['Area 2'],
  'CMSC427': ['Area 2'], 'CMSC470': ['Area 2'], 'CMSC471': ['Area 2', 'Area 3'],
  'CMSC472': ['Area 2'], 'CMSC498D': ['Area 2'], 'CMSC498E': ['Area 2'],
  'CMSC498F': ['Area 2'], 'CMSC498V': ['Area 2'], 'CMSC498Y': ['Area 2'],
  'CMSC498Z': ['Area 2'],
  // Area 3: Software Engineering and Programming Languages
  'CMSC430': ['Area 3'], 'CMSC433': ['Area 3'], 'CMSC434': ['Area 3'],
  'CMSC435': ['Area 3'], 'CMSC436': ['Area 3'],
  // Area 4: Theory
  'CMSC451': ['Area 4'], 'CMSC452': ['Area 4'], 'CMSC454': ['Area 4'],
  'CMSC456': ['Area 4'], 'CMSC457': ['Area 4'], 'CMSC474': ['Area 4'],
  // Area 5: Numerical Analysis
  'CMSC460': ['Area 5'], 'CMSC466': ['Area 5'],
  // Electives
  'CMSC320': ['Elective'], 'CMSC335': ['Elective'], 'CMSC388': ['Elective'],
  'CMSC389': ['Elective'], 'CMSC395': ['Elective'], 'CMSC396': ['Elective'],
  'CMSC401': ['Elective'], 'CMSC425': ['Elective'], 'CMSC473': ['Elective'],
  'CMSC475': ['Elective'], 'CMSC476': ['Elective'], 'CMSC477': ['Elective'],
  'CMSC488A': ['Elective'], 'CMSC498': ['Elective'], 'CMSC498A': ['Elective'],
  'CMSC499A': ['Elective']
};
