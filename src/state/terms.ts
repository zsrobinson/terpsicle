// TODO(core): replace with core's catalog helpers (default term) once M1 lands.
import type { Term, TermId } from "~/core/schema";
 ...
 * for); else the newest term at all. `terms` is newest first, as published.
 */
