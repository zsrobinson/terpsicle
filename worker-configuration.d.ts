/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: fb351b7cf11f5a759236da6e4aedd52a)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "POSTHOG_TOKEN">> {}
}
